...
function flatten_tokens(tokens) {
	return tokens.flatMap(token => token.e ?? nfc$1(token.t));
}
...
export { UNICODE, VERSION, consume_emoji_sequence, ens_normalize, get_mapped, is_combining_mark, is_disallowed, is_ignored, nfc$1 as nfc, nfc as nfc0, nfd$1 as nfd, nfd as nfd0, puny_decode, tokenized_idna };
