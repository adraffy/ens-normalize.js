...
let idna_allowed = new Set([
	...IDNA.valid,
	...IDNA.ignored,
	...IDNA.mapped.map(v => v[0])
]);
let additional_disallowed = [...DISALLOWED].filter(cp => idna_allowed.has(cp));
...
write_csv('disallowed', additional_disallowed);
...
write_csv('valid', [...valid].sort((a, b) => a - b));