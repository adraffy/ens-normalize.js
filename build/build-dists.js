...
function generate_release_lib({name, file, versions = false}) {
...
/*
// build release
await build(generate_release_lib({name: 'adraffy', file: 'lib-normalize-v1.js'}), 'ens-normalize');
await build(generate_release_lib({name: 'adraffy', file: 'lib-normalize-v1.js', versions: true}), 'ens-normalize-debug');
