export default [
	...
	// 0xFF3F, // (＿) FULLWIDTH LOW LINE => [5F] (_) LOW LINE
	...
	// 0xFFE3, // (￣) FULLWIDTH MACRON => [20 304] ( ̄) SPACE + COMBINING MACRON
	...
	*/
	...
	0x34F, // (◌͏) COMBINING GRAPHEME JOINER // this is ignored in IDNA but has ZWJ vibes
	...
	*/
	...
	0x1FA54, // (🩔) WHITE CHESS FERZ (20250806: unicode 17)
	...
	0x2B96, // (⮖) EQUALS SIGN WITH INFINITY ABOVE (20250806: unicode 17)
	...
	0x1CEF0, // (𜻰) MEDIUM SMALL WHITE CIRCLE WITH HORIZONTAL BAR (20250803: unicode 17)
	...
	// 0x1CC6D, // (𜱭) BLACK LARGE CIRCLE MINUS RIGHT QUARTER SECTION // pacman!
	...
	// 0x1CCD6, // (𜳖) OUTLINED LATIN CAPITAL LETTER A // 20240912: currently mapped by IDNA
	...
	*/
	...
	0x1D176, // (𝅶) MUSICAL SYMBOL END TIE      | // in 16.0.0, these became ignored
	0x1D177, // (𝅷) MUSICAL SYMBOL BEGIN SLUR   | // 20240912: stay disallowed
	...
	*/
	...
	// 20240912: in 16.0.0 a bunch of invisibles were changed to ignored
	// decision: keep these disabled
	...
	// ************************************************************
	// things missing from 16.0.0 update

	// these somehow missed the purge? 
	// need to review and check damage, likey some of are used
	// checked: few regs, all expired
	0x2798, // (➘) HEAVY SOUTH EAST ARROW
	0x2799, // (➙) HEAVY RIGHTWARDS ARROW
	//0x279A, // (➚) HEAVY NORTH EAST ARROW (has reg: 1yr)
	0x279B, // (➛) DRAFTING POINT RIGHTWARDS ARROW
	0x279C, // (➜) HEAVY ROUND-TIPPED RIGHTWARDS ARROW (has regs)
	...
	0x27A0, // (➠) HEAVY DASHED TRIANGLE-HEADED RIGHTWARDS ARROW (has regs)
	0x27A2, // (➢) THREE-D TOP-LIGHTED RIGHTWARDS ARROWHEAD
	0x27A3, // (➣) THREE-D BOTTOM-LIGHTED RIGHTWARDS ARROWHEAD
	//0x27A4, // (➤) BLACK RIGHTWARDS ARROWHEAD (has reg: 1yr)
	...
	0x27B1, // (➱) NOTCHED UPPER RIGHT-SHADOWED WHITE RIGHTWARDS ARROW (blocked above)
	0x27B2, // (➲) CIRCLED HEAVY WHITE RIGHTWARDS ARROW
	0x27B3, // (➳) WHITE-FEATHERED RIGHTWARDS ARROW (has regs: 1)
	0x27B4, // (➴) BLACK-FEATHERED SOUTH EAST ARROW
	0x27B5, // (➵) BLACK-FEATHERED RIGHTWARDS ARROW (has regs: 1)
	0x27B6, // (➶) BLACK-FEATHERED NORTH EAST ARROW
	0x27B7, // (➷) HEAVY BLACK-FEATHERED SOUTH EAST ARROW (has regs: 1)
	0x27B8, // (➸) HEAVY BLACK-FEATHERED RIGHTWARDS ARROW
	0x27B9, // (➹) HEAVY BLACK-FEATHERED NORTH EAST ARROW (has regs: 1)
	...
	// 20240926: these are still disabled
	// 20250806: still disabled
	/*
